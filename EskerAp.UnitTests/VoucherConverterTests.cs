...
namespace EskerAp.UnitTests
{
	...
	public class VoucherConverterTests
	{
		...
		public void ConvertString()
		{
			...
			Assert.AreEqual(1, voucher.Lines.Where(x => x.CostCenterId == "6001" && x.GlAccountCode == "" && x.Quantity == 1 && x.Amount == 2582.78M && x.PhaseId == "").Count());
			Assert.AreEqual(1, voucher.Lines.Where(x => x.CostCenterId == "1007" && x.GlAccountCode == "" && x.Quantity == 1 && x.Amount == 3759.36M && x.PhaseId == "").Count()); 
			Assert.AreEqual(1, voucher.Lines.Where(x => x.CostCenterId == "1008" && x.GlAccountCode == "" && x.Quantity == 1 && x.Amount == 10022.6M && x.PhaseId == "").Count());
